        ...
        <div class="w-full px-4 md:w-8/12 lg:w-7/12">
          <div class="mb-8 max-w-[570px] md:mb-0 lg:mb-12">
            ...
            <p class="text-base font-medium leading-relaxed text-body-color">
              If you require any of our services or have inquiries, we invite you to reach out to us. Please utilize the convenient form below to contact us directly. Alternatively, you can contact us via the provided email addresses or phone numbers. Your inquiries are important to us, and we look forward to assisting you.
        ...
        <div class="w-full px-4 md:w-4/12 lg:w-5/12">
          <div class="text-end">
            <ul class="flex items-center md:justify-end">
              ...
              <li class="text-base font-medium text-primary">Contact Page</li>
            </ul>
          </div>
        </div>
      </div>
