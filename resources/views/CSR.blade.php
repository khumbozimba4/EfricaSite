        ...
        <div class="w-full px-4 md:w-8/12 lg:w-7/12">
          <div class="mb-8 max-w-[570px] md:mb-0 lg:mb-12">
            ...
            <p class="text-base  font-medium leading-relaxed text-body-color">
                Efrica, a prominent player in IT, excels in software engineering
                and cybersecurity. Committed to Corporate Social Responsibility (CSR),
                we prioritize ethical practices, community support, and environmental 
                sustainability. At Efrica, CSR is ingrained in our values, reflecting our
                dedication to making a positive impact in the IT sector and beyond.
            </p>
          </div>
        </div>
        <div class="w-full px-4 md:w-4/12 lg:w-5/12">
          <div class="text-end">
            <ul class="flex items-center md:justify-end">
              ...
              <li class="text-base font-medium text-primary">CSR</li>
            </ul>
          </div>
        </div>
      </div>
